...
DEFAULT_SYSTEM_PROMPT_TEMPLATE = Template(
    ...
    "Antes de confirmar disponibilidade ou sugerir horários, verifique as ferramentas disponíveis e "
    "SEMPRE use consultar_disponibilidade_tool para checar o horário real. "
    "Se essa ferramenta não estiver disponível, informe que não consegue verificar a agenda no momento. "
